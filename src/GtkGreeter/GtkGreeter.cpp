...
class GtkGreeter : public MessengerInterface, public ComponentInterface
{
    public:
        GtkGreeter();
        virtual ~GtkGreeter();
...
void GtkGreeter:: std::string say();
{
    GtkWidget *window;
    GtkWidget *button;
    ...
    std::string greeting;
    greeting = "I am the gtk greeter and the message is: "+say();
